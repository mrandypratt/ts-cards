...
export const allCardText = {
  ...
  responses: {
    clean: [
      ...
      "Getting real sick of wearing underwear and responsibility.",
      ...
      "A nice customer service who you can't understand due to their accent",
      ...
      "An Airbnb in rural Kansas",
      "Smiling while silently screaming inside",
      "To-go beers",
      "A lonely old man in a park feeding pidgeons that aren't there",
      "An old mental hospital haunted by ghosts of the insane",
      "Smelly, old fruit",
      "Being visually shocked",
      "Becoming grumpier with each small inconvenience",
      "Waiting for death's swee chariot of relief",
      "Getting detained by international customs",
      "Appreciating Alexa for listening when no one else will",
      "Peanut butter and jelly pizza",
      "A charging cable that doesn't quite reach the nightstand",
      "Listening to the radio out of sheer lack of desire",
      "A car that drives itself, but only where it decides to go",
      "Poorly lit selfies leaked from your iCloud",
      "Your full bank account and social security number",
      "Feeling that there is more to life, but the couch is really comfy",
      "Tricking your spouse into loving you for your entire life",
      "Saying \"I love you, but... nevermind\"",
      "A small, weak, little man",
      "A strong-willed woman struggling to open a jar of pickles",
      "Blaming the economy",
      "A button that ends world hunger sponsored by McDonald's",
      "The death of the nuclear family",
      "Kangaroos with candy in their pouches",
      // "",
      // "",
      // "",
      // "",
